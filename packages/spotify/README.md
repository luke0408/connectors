...
By installing the package, you can use functions for `Spotify`.
...
install the `@wrtnlabs/connector-spotify` package.

```bash
npm install @wrtnlabs/connector-spotify
```

### Usage

```ts
import { SpotifyService } from "@wrtnlabs/connector-spotify";
    ...
    controllers: [
      {
        ...
        protocol: "class",
        application: typia.llm.application<SpotifyService, "chatgpt">(),
        execute: new SpotifyService(),
      },
    ],
  });
